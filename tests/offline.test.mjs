...
let waiting;handlers.install({waitUntil:p=>waiting=p});await waiting;assert([...cacheData.entries()].find(([key])=>key.startsWith('endgame-')&&key!=='endgame-old')[1].size>=37);
